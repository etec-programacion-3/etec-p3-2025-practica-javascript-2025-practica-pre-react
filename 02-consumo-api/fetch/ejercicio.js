...
// Render inicial
fetchProducts(); 
// Llama a fetchProducts para cargar los productos al inicio
document.addEventListener('DOMContentLoaded', fetchProducts); // Asegura que se carguen al inicio
// Asegura que se carguen al inicio
